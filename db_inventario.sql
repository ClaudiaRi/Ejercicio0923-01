...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-09-2016 a las 02:14:23
...
INSERT INTO `tbl_unidad_medida` (`id_unidad_medida`, `nombre`, `abreviado`) VALUES
(1, 'metros', 'mts'),
(2, 'centímetros', 'cm'),
(3, 'milímetros', 'ml'),
(4, 'kilometros', 'km');
...
ALTER TABLE `tbl_producto`
  ADD PRIMARY KEY (`id_producto`), ADD KEY `id_unidad_medida` (`id_unidad_medida`);
...
('root', '2016-09-23 23:49:45', '{"lang":"es","collation_connection":"utf8mb4_unicode_ci"}');
